...
<div class="step flex flex-col justify-evenly w-full">
    ...
    <button class="py-3 bg-black font-bold text-white rounded-full w-full my-5 mx-auto flex items-center justify-evenly px-20 lg:w-1/4 lg:mr-0 lg:py-2 lg:w-1/2 lg:py-2" onclick="nextStep()">
        <p>Suivant</p>
