...
<div class="step flex flex-col justify-evenly w-full">
    ...
    <input class="rounded-md border border-featureInput p-2 mb-5" type="number" id="budgetTotal" name="budgetTotal">

    <label class="text-featureInput" for="budgetPersonal">Budget personnel</label>
    <input class="rounded-md border border-featureInput p-2 mb-5" type="number" id="budgetPersonal" name="budgetPersonal">

    <label class="text-featureInput" for="budgetLeisure">Budget loisir</label>
    <input class="rounded-md border border-featureInput p-2 mb-5" type="number" id="budgetLeisure" name="budgetLeisure">

    <h3 class="text-xl font-bold my-5">Pour une durée de ...</h3>
    <label class="text-featureInput" for="startDate">Date de début</label>
    <input class="rounded-md border border-featureInput p-2 mb-5" type="date" id="startDate" name="startDate">

    <label  class="text-featureInput"for="endDate">Date de fin</label>
    <input class="rounded-md border border-featureInput p-2 mb-5" type="date" id="endDate" name="endDate">
    
    <button class="py-3 bg-black font-bold text-white rounded-full w-full my-5 mx-auto flex items-center justify-evenly px-20" onclick="nextStep()"><p>Suivant</p><img src="../../assets/img/arrow-button.png" alt=""></button>
</div>
